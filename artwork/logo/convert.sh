...
macos_ico() {
    ...
    convert -size $SIZE'x'$SIZE xc:transparent -fill white -draw "roundrectangle $MIN_POS,$MIN_POS $MAX_POS,$MAX_POS $CORNER_RADIUS,$CORNER_RADIUS" $MACOS_ICO_DIR/$FILENAME.background.png
    # merge foreground and background
    convert -background none $MACOS_ICO_DIR/$FILENAME.background.png $MACOS_ICO_DIR/$FILENAME.foreground.png -layers flatten -resize $SIZE'x'$SIZE $MACOS_ICO_DIR/$FILENAME.png
