...
extern "C" {
    pub fn glActiveTexture(texture: std::os::raw::c_uint) -> ();
    pub fn glAttachShader(program: std::os::raw::c_uint, shader: std::os::raw::c_uint) -> ();
    pub fn glBindAttribLocation(program: std::os::raw::c_uint, index: std::os::raw::c_uint, name: *mut i8) -> ();
    pub fn glBindBuffer(target: std::os::raw::c_uint, buffer: std::os::raw::c_uint) -> ();
    pub fn glBindFramebuffer(target: std::os::raw::c_uint, framebuffer: std::os::raw::c_uint) -> ();
    pub fn glBindRenderbuffer(target: std::os::raw::c_uint, renderbuffer: std::os::raw::c_uint) -> ();
    pub fn glBindTexture(target: std::os::raw::c_uint, texture: std::os::raw::c_uint) -> ();
    pub fn glBlendColor(red: f32, green: f32, blue: f32, alpha: f32) -> ();
    pub fn glBlendEquation(mode: std::os::raw::c_uint) -> ();
    pub fn glBlendEquationSeparate(modeRGB: std::os::raw::c_uint, modeAlpha: std::os::raw::c_uint) -> ();
    pub fn glBlendFunc(sfactor: std::os::raw::c_uint, dfactor: std::os::raw::c_uint) -> ();
    pub fn glBlendFuncSeparate(sfactorRGB: std::os::raw::c_uint, dfactorRGB: std::os::raw::c_uint, sfactorAlpha: std::os::raw::c_uint, dfactorAlpha: std::os::raw::c_uint) -> ();
    pub fn glBufferData(target: std::os::raw::c_uint, size: isize, data: *mut (), usage: std::os::raw::c_uint) -> ();
    pub fn glBufferSubData(target: std::os::raw::c_uint, offset: isize, size: isize, data: *mut ()) -> ();
    pub fn glCheckFramebufferStatus(target: std::os::raw::c_uint) -> std::os::raw::c_uint;
    pub fn glClear(mask: std::os::raw::c_uint) -> ();
    pub fn glClearColor(red: f32, green: f32, blue: f32, alpha: f32) -> ();
    pub fn glClearDepthf(d: f32) -> ();
    pub fn glClearStencil(s: std::os::raw::c_int) -> ();
    pub fn glColorMask(red: u8, green: u8, blue: u8, alpha: u8) -> ();
    pub fn glCompileShader(shader: std::os::raw::c_uint) -> ();
    pub fn glCompressedTexImage2D(target: std::os::raw::c_uint, level: std::os::raw::c_int, internalformat: std::os::raw::c_uint, width: std::os::raw::c_int, height: std::os::raw::c_int, border: std::os::raw::c_int, imageSize: std::os::raw::c_int, data: *mut ()) -> ();
    pub fn glCompressedTexSubImage2D(target: std::os::raw::c_uint, level: std::os::raw::c_int, xoffset: std::os::raw::c_int, yoffset: std::os::raw::c_int, width: std::os::raw::c_int, height: std::os::raw::c_int, format: std::os::raw::c_uint, imageSize: std::os::raw::c_int, data: *mut ()) -> ();
    pub fn glCopyTexImage2D(target: std::os::raw::c_uint, level: std::os::raw::c_int, internalformat: std::os::raw::c_uint, x: std::os::raw::c_int, y: std::os::raw::c_int, width: std::os::raw::c_int, height: std::os::raw::c_int, border: std::os::raw::c_int) -> ();
    pub fn glCopyTexSubImage2D(target: std::os::raw::c_uint, level: std::os::raw::c_int, xoffset: std::os::raw::c_int, yoffset: std::os::raw::c_int, x: std::os::raw::c_int, y: std::os::raw::c_int, width: std::os::raw::c_int, height: std::os::raw::c_int) -> ();
    pub fn glCreateProgram() -> std::os::raw::c_uint;
    pub fn glCreateShader(_type: std::os::raw::c_uint) -> std::os::raw::c_uint;
    pub fn glCullFace(mode: std::os::raw::c_uint) -> ();
    pub fn glDeleteBuffers(n: std::os::raw::c_int, buffers: *mut std::os::raw::c_uint) -> ();
    pub fn glDeleteFramebuffers(n: std::os::raw::c_int, framebuffers: *mut std::os::raw::c_uint) -> ();
    pub fn glDeleteProgram(program: std::os::raw::c_uint) -> ();
    pub fn glDeleteRenderbuffers(n: std::os::raw::c_int, renderbuffers: *mut std::os::raw::c_uint) -> ();
    pub fn glDeleteShader(shader: std::os::raw::c_uint) -> ();
    pub fn glDeleteTextures(n: std::os::raw::c_int, textures: *mut std::os::raw::c_uint) -> ();
    pub fn glDepthFunc(func: std::os::raw::c_uint) -> ();
    pub fn glDepthMask(flag: u8) -> ();
    pub fn glDepthRangef(n: f32, f: f32) -> ();
    pub fn glDetachShader(program: std::os::raw::c_uint, shader: std::os::raw::c_uint) -> ();
    pub fn glDisable(cap: std::os::raw::c_uint) -> ();
    pub fn glDisableVertexAttribArray(index: std::os::raw::c_uint) -> ();
    pub fn glDrawArrays(mode: std::os::raw::c_uint, first: std::os::raw::c_int, count: std::os::raw::c_int) -> ();
    pub fn glDrawElements(mode: std::os::raw::c_uint, count: std::os::raw::c_int, _type: std::os::raw::c_uint, indices: *mut ()) -> ();
    pub fn glEnable(cap: std::os::raw::c_uint) -> ();
    pub fn glEnableVertexAttribArray(index: std::os::raw::c_uint) -> ();
    pub fn glFinish() -> ();
    pub fn glFlush() -> ();
    pub fn glFramebufferRenderbuffer(target: std::os::raw::c_uint, attachment: std::os::raw::c_uint, renderbuffertarget: std::os::raw::c_uint, renderbuffer: std::os::raw::c_uint) -> ();
    pub fn glFramebufferTexture2D(target: std::os::raw::c_uint, attachment: std::os::raw::c_uint, textarget: std::os::raw::c_uint, texture: std::os::raw::c_uint, level: std::os::raw::c_int) -> ();
    pub fn glFrontFace(mode: std::os::raw::c_uint) -> ();
    pub fn glGenBuffers(n: std::os::raw::c_int, buffers: *const std::os::raw::c_uint) -> ();
    pub fn glGenFramebuffers(n: std::os::raw::c_int, framebuffers: *const std::os::raw::c_uint) -> ();
    pub fn glGenRenderbuffers(n: std::os::raw::c_int, renderbuffers: *const std::os::raw::c_uint) -> ();
    pub fn glGenTextures(n: std::os::raw::c_int, textures: *const std::os::raw::c_uint) -> ();
    pub fn glGenerateMipmap(target: std::os::raw::c_uint) -> ();
    pub fn glGetActiveAttrib(program: std::os::raw::c_uint, index: std::os::raw::c_uint, bufSize: std::os::raw::c_int, length: *const std::os::raw::c_int, size: *const std::os::raw::c_int, _type: *const std::os::raw::c_uint, name: *const i8) -> ();
    pub fn glGetActiveUniform(program: std::os::raw::c_uint, index: std::os::raw::c_uint, bufSize: std::os::raw::c_int, length: *const std::os::raw::c_int, size: *const std::os::raw::c_int, _type: *const std::os::raw::c_uint, name: *const i8) -> ();
    pub fn glGetAttachedShaders(program: std::os::raw::c_uint, maxCount: std::os::raw::c_int, count: *const std::os::raw::c_int, shaders: *const std::os::raw::c_uint) -> ();
    pub fn glGetAttribLocation(program: std::os::raw::c_uint, name: *mut i8) -> std::os::raw::c_int;
    pub fn glGetBooleanv(pname: std::os::raw::c_uint, data: *const u8) -> ();
    pub fn glGetBufferParameteriv(target: std::os::raw::c_uint, pname: std::os::raw::c_uint, params: *const std::os::raw::c_int) -> ();
    pub fn glGetError() -> std::os::raw::c_uint;
    pub fn glGetFloatv(pname: std::os::raw::c_uint, data: *const f32) -> ();
    pub fn glGetFramebufferAttachmentParameteriv(target: std::os::raw::c_uint, attachment: std::os::raw::c_uint, pname: std::os::raw::c_uint, params: *const std::os::raw::c_int) -> ();
    pub fn glGetIntegerv(pname: std::os::raw::c_uint, data: *const std::os::raw::c_int) -> ();
    pub fn glGetProgramInfoLog(program: std::os::raw::c_uint, bufSize: std::os::raw::c_int, length: *const std::os::raw::c_int, infoLog: *const i8) -> ();
    pub fn glGetProgramiv(program: std::os::raw::c_uint, pname: std::os::raw::c_uint, params: *const std::os::raw::c_int) -> ();
    pub fn glGetRenderbufferParameteriv(target: std::os::raw::c_uint, pname: std::os::raw::c_uint, params: *const std::os::raw::c_int) -> ();
    pub fn glGetShaderInfoLog(shader: std::os::raw::c_uint, bufSize: std::os::raw::c_int, length: *const std::os::raw::c_int, infoLog: *const i8) -> ();
    pub fn glGetShaderPrecisionFormat(shadertype: std::os::raw::c_uint, precisiontype: std::os::raw::c_uint, range: *const std::os::raw::c_int, precision: *const std::os::raw::c_int) -> ();
    pub fn glGetShaderSource(shader: std::os::raw::c_uint, bufSize: std::os::raw::c_int, length: *const std::os::raw::c_int, source: *const i8) -> ();
    pub fn glGetShaderiv(shader: std::os::raw::c_uint, pname: std::os::raw::c_uint, params: *const std::os::raw::c_int) -> ();
    pub fn glGetString(name: std::os::raw::c_uint) -> *mut u8;
    pub fn glGetTexParameterfv(target: std::os::raw::c_uint, pname: std::os::raw::c_uint, params: *const f32) -> ();
    pub fn glGetTexParameteriv(target: std::os::raw::c_uint, pname: std::os::raw::c_uint, params: *const std::os::raw::c_int) -> ();
    pub fn glGetUniformLocation(program: std::os::raw::c_uint, name: *mut i8) -> std::os::raw::c_int;
    pub fn glGetUniformfv(program: std::os::raw::c_uint, location: std::os::raw::c_int, params: *const f32) -> ();
    pub fn glGetUniformiv(program: std::os::raw::c_uint, location: std::os::raw::c_int, params: *const std::os::raw::c_int) -> ();
    pub fn glGetVertexAttribPointerv(index: std::os::raw::c_uint, pname: std::os::raw::c_uint, pointer: *const *const ()) -> ();
    pub fn glGetVertexAttribfv(index: std::os::raw::c_uint, pname: std::os::raw::c_uint, params: *const f32) -> ();
    pub fn glGetVertexAttribiv(index: std::os::raw::c_uint, pname: std::os::raw::c_uint, params: *const std::os::raw::c_int) -> ();
    pub fn glHint(target: std::os::raw::c_uint, mode: std::os::raw::c_uint) -> ();
    pub fn glIsBuffer(buffer: std::os::raw::c_uint) -> u8;
    pub fn glIsEnabled(cap: std::os::raw::c_uint) -> u8;
    pub fn glIsFramebuffer(framebuffer: std::os::raw::c_uint) -> u8;
    pub fn glIsProgram(program: std::os::raw::c_uint) -> u8;
    pub fn glIsRenderbuffer(renderbuffer: std::os::raw::c_uint) -> u8;
    pub fn glIsShader(shader: std::os::raw::c_uint) -> u8;
    pub fn glIsTexture(texture: std::os::raw::c_uint) -> u8;
    pub fn glLineWidth(width: f32) -> ();
    pub fn glLinkProgram(program: std::os::raw::c_uint) -> ();
    pub fn glPixelStorei(pname: std::os::raw::c_uint, param: std::os::raw::c_int) -> ();
    pub fn glPolygonOffset(factor: f32, units: f32) -> ();
    pub fn glReadPixels(x: std::os::raw::c_int, y: std::os::raw::c_int, width: std::os::raw::c_int, height: std::os::raw::c_int, format: std::os::raw::c_uint, _type: std::os::raw::c_uint, pixels: *const ()) -> ();
    pub fn glReleaseShaderCompiler() -> ();
    pub fn glRenderbufferStorage(target: std::os::raw::c_uint, internalformat: std::os::raw::c_uint, width: std::os::raw::c_int, height: std::os::raw::c_int) -> ();
    pub fn glSampleCoverage(value: f32, invert: u8) -> ();
    pub fn glScissor(x: std::os::raw::c_int, y: std::os::raw::c_int, width: std::os::raw::c_int, height: std::os::raw::c_int) -> ();
    pub fn glShaderBinary(count: std::os::raw::c_int, shaders: *mut std::os::raw::c_uint, binaryFormat: std::os::raw::c_uint, binary: *mut (), length: std::os::raw::c_int) -> ();
    pub fn glShaderSource(shader: std::os::raw::c_uint, count: std::os::raw::c_int, string: *mut *mut i8, length: *mut std::os::raw::c_int) -> ();
    pub fn glStencilFunc(func: std::os::raw::c_uint, _ref: std::os::raw::c_int, mask: std::os::raw::c_uint) -> ();
    pub fn glStencilFuncSeparate(face: std::os::raw::c_uint, func: std::os::raw::c_uint, _ref: std::os::raw::c_int, mask: std::os::raw::c_uint) -> ();
    pub fn glStencilMask(mask: std::os::raw::c_uint) -> ();
    pub fn glStencilMaskSeparate(face: std::os::raw::c_uint, mask: std::os::raw::c_uint) -> ();
    pub fn glStencilOp(fail: std::os::raw::c_uint, zfail: std::os::raw::c_uint, zpass: std::os::raw::c_uint) -> ();
    pub fn glStencilOpSeparate(face: std::os::raw::c_uint, sfail: std::os::raw::c_uint, dpfail: std::os::raw::c_uint, dppass: std::os::raw::c_uint) -> ();
    pub fn glTexImage2D(target: std::os::raw::c_uint, level: std::os::raw::c_int, internalformat: std::os::raw::c_int, width: std::os::raw::c_int, height: std::os::raw::c_int, border: std::os::raw::c_int, format: std::os::raw::c_uint, _type: std::os::raw::c_uint, pixels: *mut ()) -> ();
    pub fn glTexParameterf(target: std::os::raw::c_uint, pname: std::os::raw::c_uint, param: f32) -> ();
    pub fn glTexParameterfv(target: std::os::raw::c_uint, pname: std::os::raw::c_uint, params: *mut f32) -> ();
    pub fn glTexParameteri(target: std::os::raw::c_uint, pname: std::os::raw::c_uint, param: std::os::raw::c_int) -> ();
    pub fn glTexParameteriv(target: std::os::raw::c_uint, pname: std::os::raw::c_uint, params: *mut std::os::raw::c_int) -> ();
    pub fn glTexSubImage2D(target: std::os::raw::c_uint, level: std::os::raw::c_int, xoffset: std::os::raw::c_int, yoffset: std::os::raw::c_int, width: std::os::raw::c_int, height: std::os::raw::c_int, format: std::os::raw::c_uint, _type: std::os::raw::c_uint, pixels: *mut ()) -> ();
    pub fn glUniform1f(location: std::os::raw::c_int, v0: f32) -> ();
    pub fn glUniform1fv(location: std::os::raw::c_int, count: std::os::raw::c_int, value: *mut f32) -> ();
    pub fn glUniform1i(location: std::os::raw::c_int, v0: std::os::raw::c_int) -> ();
    pub fn glUniform1iv(location: std::os::raw::c_int, count: std::os::raw::c_int, value: *mut std::os::raw::c_int) -> ();
    pub fn glUniform2f(location: std::os::raw::c_int, v0: f32, v1: f32) -> ();
    pub fn glUniform2fv(location: std::os::raw::c_int, count: std::os::raw::c_int, value: *mut f32) -> ();
    pub fn glUniform2i(location: std::os::raw::c_int, v0: std::os::raw::c_int, v1: std::os::raw::c_int) -> ();
    pub fn glUniform2iv(location: std::os::raw::c_int, count: std::os::raw::c_int, value: *mut std::os::raw::c_int) -> ();
    pub fn glUniform3f(location: std::os::raw::c_int, v0: f32, v1: f32, v2: f32) -> ();
    pub fn glUniform3fv(location: std::os::raw::c_int, count: std::os::raw::c_int, value: *mut f32) -> ();
    pub fn glUniform3i(location: std::os::raw::c_int, v0: std::os::raw::c_int, v1: std::os::raw::c_int, v2: std::os::raw::c_int) -> ();
    pub fn glUniform3iv(location: std::os::raw::c_int, count: std::os::raw::c_int, value: *mut std::os::raw::c_int) -> ();
    pub fn glUniform4f(location: std::os::raw::c_int, v0: f32, v1: f32, v2: f32, v3: f32) -> ();
    pub fn glUniform4fv(location: std::os::raw::c_int, count: std::os::raw::c_int, value: *mut f32) -> ();
    pub fn glUniform4i(location: std::os::raw::c_int, v0: std::os::raw::c_int, v1: std::os::raw::c_int, v2: std::os::raw::c_int, v3: std::os::raw::c_int) -> ();
    pub fn glUniform4iv(location: std::os::raw::c_int, count: std::os::raw::c_int, value: *mut std::os::raw::c_int) -> ();
    pub fn glUniformMatrix2fv(location: std::os::raw::c_int, count: std::os::raw::c_int, transpose: u8, value: *mut f32) -> ();
    pub fn glUniformMatrix3fv(location: std::os::raw::c_int, count: std::os::raw::c_int, transpose: u8, value: *mut f32) -> ();
    pub fn glUniformMatrix4fv(location: std::os::raw::c_int, count: std::os::raw::c_int, transpose: u8, value: *mut f32) -> ();
    pub fn glUseProgram(program: std::os::raw::c_uint) -> ();
    pub fn glValidateProgram(program: std::os::raw::c_uint) -> ();
    pub fn glVertexAttrib1f(index: std::os::raw::c_uint, x: f32) -> ();
    pub fn glVertexAttrib1fv(index: std::os::raw::c_uint, v: *mut f32) -> ();
    pub fn glVertexAttrib2f(index: std::os::raw::c_uint, x: f32, y: f32) -> ();
    pub fn glVertexAttrib2fv(index: std::os::raw::c_uint, v: *mut f32) -> ();
    pub fn glVertexAttrib3f(index: std::os::raw::c_uint, x: f32, y: f32, z: f32) -> ();
    pub fn glVertexAttrib3fv(index: std::os::raw::c_uint, v: *mut f32) -> ();
    pub fn glVertexAttrib4f(index: std::os::raw::c_uint, x: f32, y: f32, z: f32, w: f32) -> ();
    pub fn glVertexAttrib4fv(index: std::os::raw::c_uint, v: *mut f32) -> ();
    pub fn glVertexAttribPointer(index: std::os::raw::c_uint, size: std::os::raw::c_int, _type: std::os::raw::c_uint, normalized: u8, stride: std::os::raw::c_int, pointer: *mut ()) -> ();
    pub fn glViewport(x: std::os::raw::c_int, y: std::os::raw::c_int, width: std::os::raw::c_int, height: std::os::raw::c_int) -> ();
}
...
pub const GL_445SCISSOR_BIT: u32 = 0x00080000;
...
pub const GL_EXTERNAL_STORAGE_BIT_NVX: u32 = 0x2000;
pub const GL_COVERAGE_BUFFER_BIT_NV: u32 = 0x00008000;
...
pub const GL_MAP_READ_BIT_EXT: u32 = 0x0001;
pub const GL_MAP_WRITE_BIT: u32 = 0x0002;
pub const GL_MAP_WRITE_BIT_EXT: u32 = 0x0002;
pub const GL_MAP_INVALIDATE_RANGE_BIT: u32 = 0x0004;
pub const GL_MAP_INVALIDATE_RANGE_BIT_EXT: u32 = 0x0004;
pub const GL_MAP_INVALIDATE_BUFFER_BIT: u32 = 0x0008;
pub const GL_MAP_INVALIDATE_BUFFER_BIT_EXT: u32 = 0x0008;
pub const GL_MAP_FLUSH_EXPLICIT_BIT: u32 = 0x0010;
pub const GL_MAP_FLUSH_EXPLICIT_BIT_EXT: u32 = 0x0010;
pub const GL_MAP_UNSYNCHRONIZED_BIT: u32 = 0x0020;
pub const GL_MAP_UNSYNCHRONIZED_BIT_EXT: u32 = 0x0020;
...
pub const GL_SYNC_FLUSH_COMMANDS_BIT_APPLE: u32 = 0x00000001;
pub const GL_VERTEX_SHADER_BIT: u32 = 0x00000001;
pub const GL_VERTEX_SHADER_BIT_EXT: u32 = 0x00000001;
pub const GL_FRAGMENT_SHADER_BIT: u32 = 0x00000002;
pub const GL_FRAGMENT_SHADER_BIT_EXT: u32 = 0x00000002;
pub const GL_GEOMETRY_SHADER_BIT: u32 = 0x00000004;
pub const GL_GEOMETRY_SHADER_BIT_EXT: u32 = 0x00000004;
pub const GL_GEOMETRY_SHADER_BIT_OES: u32 = 0x00000004;
pub const GL_TESS_CONTROL_SHADER_BIT: u32 = 0x00000008;
pub const GL_TESS_CONTROL_SHADER_BIT_EXT: u32 = 0x00000008;
pub const GL_TESS_CONTROL_SHADER_BIT_OES: u32 = 0x00000008;
pub const GL_TESS_EVALUATION_SHADER_BIT: u32 = 0x00000010;
pub const GL_TESS_EVALUATION_SHADER_BIT_EXT: u32 = 0x00000010;
pub const GL_TESS_EVALUATION_SHADER_BIT_OES: u32 = 0x00000010;
...
pub const GL_ALL_SHADER_BITS_EXT: u32 = 0xFFFFFFFF;
...
pub const GL_TRACE_OPERATIONS_BIT_MESA: u32 = 0x0001;
pub const GL_TRACE_PRIMITIVES_BIT_MESA: u32 = 0x0002;
pub const GL_TRACE_ARRAYS_BIT_MESA: u32 = 0x0004;
pub const GL_TRACE_TEXTURES_BIT_MESA: u32 = 0x0008;
pub const GL_TRACE_PIXELS_BIT_MESA: u32 = 0x0010;
pub const GL_TRACE_ERRORS_BIT_MESA: u32 = 0x0020;
pub const GL_TRACE_ALL_BITS_MESA: u32 = 0xFFFF;
...
pub const GL_COLOR_BUFFER_BIT0_QCOM: u32 = 0x00000001;
pub const GL_COLOR_BUFFER_BIT1_QCOM: u32 = 0x00000002;
pub const GL_COLOR_BUFFER_BIT2_QCOM: u32 = 0x00000004;
pub const GL_COLOR_BUFFER_BIT3_QCOM: u32 = 0x00000008;
pub const GL_COLOR_BUFFER_BIT4_QCOM: u32 = 0x00000010;
pub const GL_COLOR_BUFFER_BIT5_QCOM: u32 = 0x00000020;
pub const GL_COLOR_BUFFER_BIT6_QCOM: u32 = 0x00000040;
pub const GL_COLOR_BUFFER_BIT7_QCOM: u32 = 0x00000080;
pub const GL_DEPTH_BUFFER_BIT0_QCOM: u32 = 0x00000100;
pub const GL_DEPTH_BUFFER_BIT1_QCOM: u32 = 0x00000200;
pub const GL_DEPTH_BUFFER_BIT2_QCOM: u32 = 0x00000400;
pub const GL_DEPTH_BUFFER_BIT3_QCOM: u32 = 0x00000800;
pub const GL_DEPTH_BUFFER_BIT4_QCOM: u32 = 0x00001000;
pub const GL_DEPTH_BUFFER_BIT5_QCOM: u32 = 0x00002000;
pub const GL_DEPTH_BUFFER_BIT6_QCOM: u32 = 0x00004000;
pub const GL_DEPTH_BUFFER_BIT7_QCOM: u32 = 0x00008000;
pub const GL_STENCIL_BUFFER_BIT0_QCOM: u32 = 0x00010000;
pub const GL_STENCIL_BUFFER_BIT1_QCOM: u32 = 0x00020000;
pub const GL_STENCIL_BUFFER_BIT2_QCOM: u32 = 0x00040000;
pub const GL_STENCIL_BUFFER_BIT3_QCOM: u32 = 0x00080000;
pub const GL_STENCIL_BUFFER_BIT4_QCOM: u32 = 0x00100000;
pub const GL_STENCIL_BUFFER_BIT5_QCOM: u32 = 0x00200000;
pub const GL_STENCIL_BUFFER_BIT6_QCOM: u32 = 0x00400000;
pub const GL_STENCIL_BUFFER_BIT7_QCOM: u32 = 0x00800000;
pub const GL_MULTISAMPLE_BUFFER_BIT0_QCOM: u32 = 0x01000000;
pub const GL_MULTISAMPLE_BUFFER_BIT1_QCOM: u32 = 0x02000000;
pub const GL_MULTISAMPLE_BUFFER_BIT2_QCOM: u32 = 0x04000000;
pub const GL_MULTISAMPLE_BUFFER_BIT3_QCOM: u32 = 0x08000000;
pub const GL_MULTISAMPLE_BUFFER_BIT4_QCOM: u32 = 0x10000000;
pub const GL_MULTISAMPLE_BUFFER_BIT5_QCOM: u32 = 0x20000000;
pub const GL_MULTISAMPLE_BUFFER_BIT6_QCOM: u32 = 0x40000000;
pub const GL_MULTISAMPLE_BUFFER_BIT7_QCOM: u32 = 0x80000000;
pub const GL_FOVEATION_ENABLE_BIT_QCOM: u32 = 0x00000001;
pub const GL_FOVEATION_SCALED_BIN_METHOD_BIT_QCOM: u32 = 0x00000002;
...
pub const GL_QUADS_EXT: u32 = 0x0007;
pub const GL_QUADS_OES: u32 = 0x0007;
...
pub const GL_LINES_ADJACENCY_OES: u32 = 0x000A;
...
pub const GL_LINE_STRIP_ADJACENCY_OES: u32 = 0x000B;
...
pub const GL_TRIANGLES_ADJACENCY_OES: u32 = 0x000C;
...
pub const GL_TRIANGLE_STRIP_ADJACENCY_OES: u32 = 0x000D;
pub const GL_PATCHES: u32 = 0x000E;
pub const GL_PATCHES_EXT: u32 = 0x000E;
pub const GL_PATCHES_OES: u32 = 0x000E;
...
pub const GL_SRC_ALPHA_SATURATE_EXT: u32 = 0x0308;
...
pub const GL_INVALID_FRAMEBUFFER_OPERATION_OES: u32 = 0x0506;
pub const GL_CONTEXT_LOST: u32 = 0x0507;
pub const GL_CONTEXT_LOST_KHR: u32 = 0x0507;
...
pub const GL_POLYGON_MODE_NV: u32 = 0x0B40;
...
pub const GL_ALPHA_TEST_QCOM: u32 = 0x0BC0;
pub const GL_ALPHA_TEST_FUNC: u32 = 0x0BC1;
pub const GL_ALPHA_TEST_FUNC_QCOM: u32 = 0x0BC1;
pub const GL_ALPHA_TEST_REF: u32 = 0x0BC2;
pub const GL_ALPHA_TEST_REF_QCOM: u32 = 0x0BC2;
...
pub const GL_LOGIC_OP: u32 = 0x0BF1;
pub const GL_COLOR_LOGIC_OP: u32 = 0x0BF2;
pub const GL_AUX_BUFFERS: u32 = 0x0C00;
pub const GL_DRAW_BUFFER: u32 = 0x0C01;
pub const GL_DRAW_BUFFER_EXT: u32 = 0x0C01;
pub const GL_READ_BUFFER: u32 = 0x0C02;
pub const GL_READ_BUFFER_EXT: u32 = 0x0C02;
pub const GL_READ_BUFFER_NV: u32 = 0x0C02;
...
pub const GL_MAX_CLIP_PLANES_IMG: u32 = 0x0D32;
...
pub const GL_TEXTURE_BORDER_COLOR_EXT: u32 = 0x1004;
pub const GL_TEXTURE_BORDER_COLOR_NV: u32 = 0x1004;
pub const GL_TEXTURE_BORDER_COLOR_OES: u32 = 0x1004;
...
pub const GL_2_BYTES_NV: u32 = 0x1407;
pub const GL_3_BYTES: u32 = 0x1408;
pub const GL_3_BYTES_NV: u32 = 0x1408;
pub const GL_4_BYTES: u32 = 0x1409;
pub const GL_4_BYTES_NV: u32 = 0x1409;
pub const GL_DOUBLE: u32 = 0x140A;
pub const GL_DOUBLE_EXT: u32 = 0x140A;
...
pub const GL_COLOR_EXT: u32 = 0x1800;
pub const GL_DEPTH: u32 = 0x1801;
pub const GL_DEPTH_EXT: u32 = 0x1801;
pub const GL_STENCIL: u32 = 0x1802;
pub const GL_STENCIL_EXT: u32 = 0x1802;
...
pub const GL_POINT_NV: u32 = 0x1B00;
pub const GL_LINE: u32 = 0x1B01;
pub const GL_LINE_NV: u32 = 0x1B01;
pub const GL_FILL: u32 = 0x1B02;
pub const GL_FILL_NV: u32 = 0x1B02;
...
pub const GL_EYE_LINEAR_NV: u32 = 0x2400;
pub const GL_OBJECT_LINEAR: u32 = 0x2401;
pub const GL_OBJECT_LINEAR_NV: u32 = 0x2401;
pub const GL_SPHERE_MAP: u32 = 0x2402;
pub const GL_TEXTURE_GEN_MODE: u32 = 0x2500;
pub const GL_TEXTURE_GEN_MODE_OES: u32 = 0x2500;
...
pub const GL_POLYGON_OFFSET_POINT_NV: u32 = 0x2A01;
pub const GL_POLYGON_OFFSET_LINE: u32 = 0x2A02;
pub const GL_POLYGON_OFFSET_LINE_NV: u32 = 0x2A02;
...
pub const GL_CLIP_PLANE0_IMG: u32 = 0x3000;
...
pub const GL_CLIP_PLANE1_IMG: u32 = 0x3001;
...
pub const GL_CLIP_PLANE2_IMG: u32 = 0x3002;
...
pub const GL_CLIP_PLANE3_IMG: u32 = 0x3003;
...
pub const GL_CLIP_PLANE4_IMG: u32 = 0x3004;
...
pub const GL_CLIP_PLANE5_IMG: u32 = 0x3005;
...
pub const GL_FUNC_ADD_OES: u32 = 0x8006;
...
pub const GL_TEXTURE_3D_BINDING_OES: u32 = 0x806A;
pub const GL_TEXTURE_BINDING_3D: u32 = 0x806A;
pub const GL_TEXTURE_BINDING_3D_OES: u32 = 0x806A;
...
pub const GL_TEXTURE_3D_OES: u32 = 0x806F;
...
pub const GL_COLOR_MATRIX: u32 = 0x80B1;
pub const GL_COLOR_MATRIX_SGI: u32 = 0x80B1;
pub const GL_COLOR_MATRIX_STACK_DEPTH: u32 = 0x80B2;
pub const GL_COLOR_MATRIX_STACK_DEPTH_SGI: u32 = 0x80B2;
pub const GL_MAX_COLOR_MATRIX_STACK_DEPTH: u32 = 0x80B3;
pub const GL_MAX_COLOR_MATRIX_STACK_DEPTH_SGI: u32 = 0x80B3;
pub const GL_POST_COLOR_MATRIX_RED_SCALE: u32 = 0x80B4;
pub const GL_POST_COLOR_MATRIX_RED_SCALE_SGI: u32 = 0x80B4;
pub const GL_POST_COLOR_MATRIX_GREEN_SCALE: u32 = 0x80B5;
pub const GL_POST_COLOR_MATRIX_GREEN_SCALE_SGI: u32 = 0x80B5;
pub const GL_POST_COLOR_MATRIX_BLUE_SCALE: u32 = 0x80B6;
pub const GL_POST_COLOR_MATRIX_BLUE_SCALE_SGI: u32 = 0x80B6;
pub const GL_POST_COLOR_MATRIX_ALPHA_SCALE: u32 = 0x80B7;
pub const GL_POST_COLOR_MATRIX_ALPHA_SCALE_SGI: u32 = 0x80B7;
pub const GL_POST_COLOR_MATRIX_RED_BIAS: u32 = 0x80B8;
pub const GL_POST_COLOR_MATRIX_RED_BIAS_SGI: u32 = 0x80B8;
pub const GL_POST_COLOR_MATRIX_GREEN_BIAS: u32 = 0x80B9;
pub const GL_POST_COLOR_MATRIX_GREEN_BIAS_SGI: u32 = 0x80B9;
pub const GL_POST_COLOR_MATRIX_BLUE_BIAS: u32 = 0x80BA;
pub const GL_POST_COLOR_MATRIX_BLUE_BIAS_SGI: u32 = 0x80BA;
pub const GL_POST_COLOR_MATRIX_ALPHA_BIAS: u32 = 0x80BB;
...
pub const GL_CLAMP_TO_BORDER_EXT: u32 = 0x812D;
pub const GL_CLAMP_TO_BORDER_NV: u32 = 0x812D;
pub const GL_CLAMP_TO_BORDER_SGIS: u32 = 0x812D;
pub const GL_CLAMP_TO_BORDER_OES: u32 = 0x812D;
...
pub const GL_CONSTANT_BORDER: u32 = 0x8151;
pub const GL_CONSTANT_BORDER_HP: u32 = 0x8151;
pub const GL_REPLICATE_BORDER: u32 = 0x8153;
pub const GL_REPLICATE_BORDER_HP: u32 = 0x8153;
pub const GL_CONVOLUTION_BORDER_COLOR: u32 = 0x8154;
...
pub const GL_PIXEL_TEX_GEN_Q_CEILING_SGIX: u32 = 0x8184;
pub const GL_PIXEL_TEX_GEN_Q_ROUND_SGIX: u32 = 0x8185;
pub const GL_PIXEL_TEX_GEN_Q_FLOOR_SGIX: u32 = 0x8186;
pub const GL_PIXEL_TEX_GEN_ALPHA_LS_SGIX: u32 = 0x8189;
pub const GL_PIXEL_TEX_GEN_ALPHA_MS_SGIX: u32 = 0x818A;
...
pub const GL_PRIMITIVE_RESTART_FOR_PATCHES_SUPPORTED_OES: u32 = 0x8221;
...
pub const GL_LOSE_CONTEXT_ON_RESET_EXT: u32 = 0x8252;
pub const GL_LOSE_CONTEXT_ON_RESET_KHR: u32 = 0x8252;
pub const GL_GUILTY_CONTEXT_RESET: u32 = 0x8253;
pub const GL_GUILTY_CONTEXT_RESET_ARB: u32 = 0x8253;
pub const GL_GUILTY_CONTEXT_RESET_EXT: u32 = 0x8253;
pub const GL_GUILTY_CONTEXT_RESET_KHR: u32 = 0x8253;
pub const GL_INNOCENT_CONTEXT_RESET: u32 = 0x8254;
pub const GL_INNOCENT_CONTEXT_RESET_ARB: u32 = 0x8254;
pub const GL_INNOCENT_CONTEXT_RESET_EXT: u32 = 0x8254;
pub const GL_INNOCENT_CONTEXT_RESET_KHR: u32 = 0x8254;
pub const GL_UNKNOWN_CONTEXT_RESET: u32 = 0x8255;
pub const GL_UNKNOWN_CONTEXT_RESET_ARB: u32 = 0x8255;
pub const GL_UNKNOWN_CONTEXT_RESET_EXT: u32 = 0x8255;
pub const GL_UNKNOWN_CONTEXT_RESET_KHR: u32 = 0x8255;
pub const GL_RESET_NOTIFICATION_STRATEGY: u32 = 0x8256;
pub const GL_RESET_NOTIFICATION_STRATEGY_ARB: u32 = 0x8256;
pub const GL_RESET_NOTIFICATION_STRATEGY_EXT: u32 = 0x8256;
pub const GL_RESET_NOTIFICATION_STRATEGY_KHR: u32 = 0x8256;
pub const GL_PROGRAM_BINARY_RETRIEVABLE_HINT: u32 = 0x8257;
pub const GL_PROGRAM_SEPARABLE: u32 = 0x8258;
pub const GL_PROGRAM_SEPARABLE_EXT: u32 = 0x8258;
pub const GL_ACTIVE_PROGRAM: u32 = 0x8259;
pub const GL_ACTIVE_PROGRAM_EXT: u32 = 0x8259;
pub const GL_PROGRAM_PIPELINE_BINDING: u32 = 0x825A;
pub const GL_PROGRAM_PIPELINE_BINDING_EXT: u32 = 0x825A;
pub const GL_MAX_VIEWPORTS: u32 = 0x825B;
pub const GL_MAX_VIEWPORTS_NV: u32 = 0x825B;
pub const GL_MAX_VIEWPORTS_OES: u32 = 0x825B;
pub const GL_VIEWPORT_SUBPIXEL_BITS: u32 = 0x825C;
pub const GL_VIEWPORT_SUBPIXEL_BITS_EXT: u32 = 0x825C;
pub const GL_VIEWPORT_SUBPIXEL_BITS_NV: u32 = 0x825C;
pub const GL_VIEWPORT_SUBPIXEL_BITS_OES: u32 = 0x825C;
pub const GL_VIEWPORT_BOUNDS_RANGE: u32 = 0x825D;
pub const GL_VIEWPORT_BOUNDS_RANGE_EXT: u32 = 0x825D;
pub const GL_VIEWPORT_BOUNDS_RANGE_NV: u32 = 0x825D;
pub const GL_VIEWPORT_BOUNDS_RANGE_OES: u32 = 0x825D;
pub const GL_LAYER_PROVOKING_VERTEX: u32 = 0x825E;
pub const GL_LAYER_PROVOKING_VERTEX_EXT: u32 = 0x825E;
pub const GL_LAYER_PROVOKING_VERTEX_OES: u32 = 0x825E;
pub const GL_VIEWPORT_INDEX_PROVOKING_VERTEX: u32 = 0x825F;
pub const GL_VIEWPORT_INDEX_PROVOKING_VERTEX_EXT: u32 = 0x825F;
pub const GL_VIEWPORT_INDEX_PROVOKING_VERTEX_NV: u32 = 0x825F;
pub const GL_VIEWPORT_INDEX_PROVOKING_VERTEX_OES: u32 = 0x825F;
pub const GL_UNDEFINED_VERTEX: u32 = 0x8260;
pub const GL_UNDEFINED_VERTEX_EXT: u32 = 0x8260;
pub const GL_UNDEFINED_VERTEX_OES: u32 = 0x8260;
pub const GL_NO_RESET_NOTIFICATION: u32 = 0x8261;
pub const GL_NO_RESET_NOTIFICATION_ARB: u32 = 0x8261;
pub const GL_NO_RESET_NOTIFICATION_EXT: u32 = 0x8261;
pub const GL_NO_RESET_NOTIFICATION_KHR: u32 = 0x8261;
...
pub const GL_TEXTURE_VIEW_MIN_LEVEL_EXT: u32 = 0x82DB;
pub const GL_TEXTURE_VIEW_MIN_LEVEL_OES: u32 = 0x82DB;
pub const GL_TEXTURE_VIEW_NUM_LEVELS: u32 = 0x82DC;
pub const GL_TEXTURE_VIEW_NUM_LEVELS_EXT: u32 = 0x82DC;
pub const GL_TEXTURE_VIEW_NUM_LEVELS_OES: u32 = 0x82DC;
pub const GL_TEXTURE_VIEW_MIN_LAYER: u32 = 0x82DD;
pub const GL_TEXTURE_VIEW_MIN_LAYER_EXT: u32 = 0x82DD;
pub const GL_TEXTURE_VIEW_MIN_LAYER_OES: u32 = 0x82DD;
pub const GL_TEXTURE_VIEW_NUM_LAYERS: u32 = 0x82DE;
pub const GL_TEXTURE_VIEW_NUM_LAYERS_EXT: u32 = 0x82DE;
pub const GL_TEXTURE_VIEW_NUM_LAYERS_OES: u32 = 0x82DE;
...
pub const GL_DISPLAY_LIST: u32 = 0x82E7;
...
pub const GL_ROBUST_GPU_TIMEOUT_MS_KHR: u32 = 0x82FD;
pub const GL_DEPTH_PASS_INSTRUMENT_SGIX: u32 = 0x8310;
pub const GL_DEPTH_PASS_INSTRUMENT_COUNTERS_SGIX: u32 = 0x8311;
pub const GL_DEPTH_PASS_INSTRUMENT_MAX_SGIX: u32 = 0x8312;
pub const GL_FRAGMENTS_INSTRUMENT_SGIX: u32 = 0x8313;
pub const GL_FRAGMENTS_INSTRUMENT_COUNTERS_SGIX: u32 = 0x8314;
pub const GL_FRAGMENTS_INSTRUMENT_MAX_SGIX: u32 = 0x8315;
pub const GL_CONVOLUTION_HINT_SGIX: u32 = 0x8316;
pub const GL_YCRCB_SGIX: u32 = 0x8318;
pub const GL_YCRCBA_SGIX: u32 = 0x8319;
pub const GL_UNPACK_COMPRESSED_SIZE_SGIX: u32 = 0x831A;
pub const GL_PACK_MAX_COMPRESSED_SIZE_SGIX: u32 = 0x831B;
pub const GL_PACK_COMPRESSED_SIZE_SGIX: u32 = 0x831C;
pub const GL_SLIM8U_SGIX: u32 = 0x831D;
pub const GL_SLIM10U_SGIX: u32 = 0x831E;
pub const GL_SLIM12S_SGIX: u32 = 0x831F;
...
pub const GL_LINE_QUALITY_HINT_SGIX: u32 = 0x835B;
...
pub const GL_UNSIGNED_BYTE_2_3_3_REV_EXT: u32 = 0x8362;
pub const GL_UNSIGNED_SHORT_5_6_5: u32 = 0x8363;
pub const GL_UNSIGNED_SHORT_5_6_5_EXT: u32 = 0x8363;
pub const GL_UNSIGNED_SHORT_5_6_5_REV: u32 = 0x8364;
pub const GL_UNSIGNED_SHORT_5_6_5_REV_EXT: u32 = 0x8364;
...
pub const GL_UNSIGNED_INT_8_8_8_8_REV_EXT: u32 = 0x8367;
...
pub const GL_MIRRORED_REPEAT_OES: u32 = 0x8370;
...
pub const GL_CURRENT_FOG_COORD: u32 = 0x8453;
...
pub const GL_MAX_RENDERBUFFER_SIZE_OES: u32 = 0x84E8;
...
pub const GL_INCR_WRAP_OES: u32 = 0x8507;
pub const GL_DECR_WRAP: u32 = 0x8508;
pub const GL_DECR_WRAP_EXT: u32 = 0x8508;
pub const GL_DECR_WRAP_OES: u32 = 0x8508;
...
pub const GL_NORMAL_MAP_OES: u32 = 0x8511;
...
pub const GL_REFLECTION_MAP_OES: u32 = 0x8512;
...
pub const GL_TEXTURE_CUBE_MAP_OES: u32 = 0x8513;
...
pub const GL_TEXTURE_BINDING_CUBE_MAP_OES: u32 = 0x8514;
...
pub const GL_TEXTURE_CUBE_MAP_POSITIVE_X_OES: u32 = 0x8515;
...
pub const GL_TEXTURE_CUBE_MAP_NEGATIVE_X_OES: u32 = 0x8516;
...
pub const GL_TEXTURE_CUBE_MAP_POSITIVE_Y_OES: u32 = 0x8517;
...
pub const GL_TEXTURE_CUBE_MAP_NEGATIVE_Y_OES: u32 = 0x8518;
...
pub const GL_TEXTURE_CUBE_MAP_POSITIVE_Z_OES: u32 = 0x8519;
...
pub const GL_TEXTURE_CUBE_MAP_NEGATIVE_Z_OES: u32 = 0x851A;
...
pub const GL_MAX_CUBE_MAP_TEXTURE_SIZE_OES: u32 = 0x851C;
...
pub const GL_CONSTANT_NV: u32 = 0x8576;
...
pub const GL_SRC1_ALPHA_EXT: u32 = 0x8589;
...
pub const GL_MAX_VERTEX_UNITS_OES: u32 = 0x86A4;
...
pub const GL_WEIGHT_ARRAY_TYPE_OES: u32 = 0x86A9;
pub const GL_WEIGHT_ARRAY_STRIDE_ARB: u32 = 0x86AA;
pub const GL_WEIGHT_ARRAY_STRIDE_OES: u32 = 0x86AA;
pub const GL_WEIGHT_ARRAY_SIZE_ARB: u32 = 0x86AB;
pub const GL_WEIGHT_ARRAY_SIZE_OES: u32 = 0x86AB;
pub const GL_WEIGHT_ARRAY_POINTER_ARB: u32 = 0x86AC;
pub const GL_WEIGHT_ARRAY_POINTER_OES: u32 = 0x86AC;
...
pub const GL_DOT3_RGBA_IMG: u32 = 0x86AF;
...
pub const GL_PROGRAM_BINARY_LENGTH_OES: u32 = 0x8741;
...
pub const GL_DEPTH_STENCIL_MESA: u32 = 0x8750;
pub const GL_UNSIGNED_INT_24_8_MESA: u32 = 0x8751;
pub const GL_UNSIGNED_INT_8_24_REV_MESA: u32 = 0x8752;
pub const GL_UNSIGNED_SHORT_15_1_MESA: u32 = 0x8753;
pub const GL_UNSIGNED_SHORT_1_15_REV_MESA: u32 = 0x8754;
pub const GL_TRACE_MASK_MESA: u32 = 0x8755;
pub const GL_TRACE_NAME_MESA: u32 = 0x8756;
pub const GL_YCBCR_MESA: u32 = 0x8757;
pub const GL_PACK_INVERT_MESA: u32 = 0x8758;
pub const GL_DEBUG_OBJECT_MESA: u32 = 0x8759;
pub const GL_TEXTURE_1D_STACK_MESAX: u32 = 0x8759;
pub const GL_DEBUG_PRINT_MESA: u32 = 0x875A;
pub const GL_TEXTURE_2D_STACK_MESAX: u32 = 0x875A;
pub const GL_DEBUG_ASSERT_MESA: u32 = 0x875B;
...
pub const GL_NUM_PROGRAM_BINARY_FORMATS_OES: u32 = 0x87FE;
pub const GL_PROGRAM_BINARY_FORMATS: u32 = 0x87FF;
pub const GL_PROGRAM_BINARY_FORMATS_OES: u32 = 0x87FF;
...
pub const GL_MAX_PALETTE_MATRICES_OES: u32 = 0x8842;
pub const GL_CURRENT_PALETTE_MATRIX_ARB: u32 = 0x8843;
pub const GL_CURRENT_PALETTE_MATRIX_OES: u32 = 0x8843;
...
pub const GL_MATRIX_INDEX_ARRAY_SIZE_OES: u32 = 0x8846;
pub const GL_MATRIX_INDEX_ARRAY_TYPE_ARB: u32 = 0x8847;
pub const GL_MATRIX_INDEX_ARRAY_TYPE_OES: u32 = 0x8847;
pub const GL_MATRIX_INDEX_ARRAY_STRIDE_ARB: u32 = 0x8848;
pub const GL_MATRIX_INDEX_ARRAY_STRIDE_OES: u32 = 0x8848;
pub const GL_MATRIX_INDEX_ARRAY_POINTER_ARB: u32 = 0x8849;
pub const GL_MATRIX_INDEX_ARRAY_POINTER_OES: u32 = 0x8849;
...
pub const GL_QUERY_COUNTER_BITS_EXT: u32 = 0x8864;
...
pub const GL_CURRENT_QUERY_EXT: u32 = 0x8865;
...
pub const GL_MAX_TESS_CONTROL_INPUT_COMPONENTS_EXT: u32 = 0x886C;
pub const GL_MAX_TESS_CONTROL_INPUT_COMPONENTS_OES: u32 = 0x886C;
pub const GL_MAX_TESS_EVALUATION_INPUT_COMPONENTS: u32 = 0x886D;
pub const GL_MAX_TESS_EVALUATION_INPUT_COMPONENTS_EXT: u32 = 0x886D;
pub const GL_MAX_TESS_EVALUATION_INPUT_COMPONENTS_OES: u32 = 0x886D;
...
pub const GL_GEOMETRY_SHADER_INVOCATIONS_EXT: u32 = 0x887F;
pub const GL_GEOMETRY_SHADER_INVOCATIONS_OES: u32 = 0x887F;
...
pub const GL_FOG_COORD_ARRAY_BUFFER_BINDING: u32 = 0x889D;
pub const GL_WEIGHT_ARRAY_BUFFER_BINDING: u32 = 0x889E;
pub const GL_WEIGHT_ARRAY_BUFFER_BINDING_ARB: u32 = 0x889E;
pub const GL_WEIGHT_ARRAY_BUFFER_BINDING_OES: u32 = 0x889E;
...
pub const GL_WRITE_ONLY_OES: u32 = 0x88B9;
...
pub const GL_SRC1_COLOR_EXT: u32 = 0x88F9;
pub const GL_ONE_MINUS_SRC1_COLOR: u32 = 0x88FA;
pub const GL_ONE_MINUS_SRC1_COLOR_EXT: u32 = 0x88FA;
pub const GL_ONE_MINUS_SRC1_ALPHA: u32 = 0x88FB;
pub const GL_ONE_MINUS_SRC1_ALPHA_EXT: u32 = 0x88FB;
pub const GL_MAX_DUAL_SOURCE_DRAW_BUFFERS: u32 = 0x88FC;
pub const GL_MAX_DUAL_SOURCE_DRAW_BUFFERS_EXT: u32 = 0x88FC;
...
pub const GL_VERTEX_ATTRIB_ARRAY_DIVISOR_ANGLE: u32 = 0x88FE;
pub const GL_VERTEX_ATTRIB_ARRAY_DIVISOR_ARB: u32 = 0x88FE;
pub const GL_VERTEX_ATTRIB_ARRAY_DIVISOR_EXT: u32 = 0x88FE;
pub const GL_VERTEX_ATTRIB_ARRAY_DIVISOR_NV: u32 = 0x88FE;
...
pub const GL_GEOMETRY_LINKED_VERTICES_OUT_EXT: u32 = 0x8916;
pub const GL_GEOMETRY_LINKED_VERTICES_OUT_OES: u32 = 0x8916;
pub const GL_GEOMETRY_INPUT_TYPE: u32 = 0x8917;
pub const GL_GEOMETRY_LINKED_INPUT_TYPE_EXT: u32 = 0x8917;
pub const GL_GEOMETRY_LINKED_INPUT_TYPE_OES: u32 = 0x8917;
pub const GL_GEOMETRY_OUTPUT_TYPE: u32 = 0x8918;
pub const GL_GEOMETRY_LINKED_OUTPUT_TYPE_EXT: u32 = 0x8918;
pub const GL_GEOMETRY_LINKED_OUTPUT_TYPE_OES: u32 = 0x8918;
...
pub const GL_POINT_SIZE_ARRAY_TYPE_OES: u32 = 0x898A;
pub const GL_POINT_SIZE_ARRAY_STRIDE_OES: u32 = 0x898B;
pub const GL_POINT_SIZE_ARRAY_POINTER_OES: u32 = 0x898C;
pub const GL_MODELVIEW_MATRIX_FLOAT_AS_INT_BITS_OES: u32 = 0x898D;
pub const GL_PROJECTION_MATRIX_FLOAT_AS_INT_BITS_OES: u32 = 0x898E;
pub const GL_TEXTURE_MATRIX_FLOAT_AS_INT_BITS_OES: u32 = 0x898F;
...
pub const GL_MAX_GEOMETRY_UNIFORM_BLOCKS_EXT: u32 = 0x8A2C;
pub const GL_MAX_GEOMETRY_UNIFORM_BLOCKS_OES: u32 = 0x8A2C;
...
pub const GL_MAX_COMBINED_GEOMETRY_UNIFORM_COMPONENTS_EXT: u32 = 0x8A32;
pub const GL_MAX_COMBINED_GEOMETRY_UNIFORM_COMPONENTS_OES: u32 = 0x8A32;
...
pub const GL_SYNC_OBJECT_APPLE: u32 = 0x8A53;
...
pub const GL_SAMPLER_3D_OES: u32 = 0x8B5F;
...
pub const GL_FLOAT_MAT2x3_NV: u32 = 0x8B65;
pub const GL_FLOAT_MAT2x4: u32 = 0x8B66;
pub const GL_FLOAT_MAT2x4_NV: u32 = 0x8B66;
pub const GL_FLOAT_MAT3x2: u32 = 0x8B67;
pub const GL_FLOAT_MAT3x2_NV: u32 = 0x8B67;
pub const GL_FLOAT_MAT3x4: u32 = 0x8B68;
pub const GL_FLOAT_MAT3x4_NV: u32 = 0x8B68;
pub const GL_FLOAT_MAT4x2: u32 = 0x8B69;
pub const GL_FLOAT_MAT4x2_NV: u32 = 0x8B69;
pub const GL_FLOAT_MAT4x3: u32 = 0x8B6A;
pub const GL_FLOAT_MAT4x3_NV: u32 = 0x8B6A;
...
// DUPLICATE pub const GL_ACTIVE_PROGRAM_EXT: u32 = 0x8B8D;
...
pub const GL_POINT_SIZE_ARRAY_OES: u32 = 0x8B9C;
pub const GL_TEXTURE_CROP_RECT_OES: u32 = 0x8B9D;
pub const GL_MATRIX_INDEX_ARRAY_BUFFER_BINDING_OES: u32 = 0x8B9E;
pub const GL_POINT_SIZE_ARRAY_BUFFER_BINDING_OES: u32 = 0x8B9F;
pub const GL_FRAGMENT_PROGRAM_POSITION_MESA: u32 = 0x8BB0;
pub const GL_FRAGMENT_PROGRAM_CALLBACK_MESA: u32 = 0x8BB1;
pub const GL_FRAGMENT_PROGRAM_CALLBACK_FUNC_MESA: u32 = 0x8BB2;
pub const GL_FRAGMENT_PROGRAM_CALLBACK_DATA_MESA: u32 = 0x8BB3;
pub const GL_VERTEX_PROGRAM_POSITION_MESA: u32 = 0x8BB4;
pub const GL_VERTEX_PROGRAM_CALLBACK_MESA: u32 = 0x8BB5;
pub const GL_VERTEX_PROGRAM_CALLBACK_FUNC_MESA: u32 = 0x8BB6;
pub const GL_VERTEX_PROGRAM_CALLBACK_DATA_MESA: u32 = 0x8BB7;
...
pub const GL_TEXTURE_WIDTH_QCOM: u32 = 0x8BD2;
pub const GL_TEXTURE_HEIGHT_QCOM: u32 = 0x8BD3;
pub const GL_TEXTURE_DEPTH_QCOM: u32 = 0x8BD4;
pub const GL_TEXTURE_INTERNAL_FORMAT_QCOM: u32 = 0x8BD5;
pub const GL_TEXTURE_FORMAT_QCOM: u32 = 0x8BD6;
pub const GL_TEXTURE_TYPE_QCOM: u32 = 0x8BD7;
pub const GL_TEXTURE_IMAGE_VALID_QCOM: u32 = 0x8BD8;
pub const GL_TEXTURE_NUM_LEVELS_QCOM: u32 = 0x8BD9;
pub const GL_TEXTURE_TARGET_QCOM: u32 = 0x8BDA;
pub const GL_TEXTURE_OBJECT_VALID_QCOM: u32 = 0x8BDB;
pub const GL_STATE_RESTORE: u32 = 0x8BDC;
pub const GL_SAMPLER_EXTERNAL_2D_Y2Y_EXT: u32 = 0x8BE7;
pub const GL_TEXTURE_PROTECTED_EXT: u32 = 0x8BFA;
pub const GL_TEXTURE_FOVEATED_FEATURE_BITS_QCOM: u32 = 0x8BFB;
pub const GL_TEXTURE_FOVEATED_MIN_PIXEL_DENSITY_QCOM: u32 = 0x8BFC;
pub const GL_TEXTURE_FOVEATED_FEATURE_QUERY_QCOM: u32 = 0x8BFD;
pub const GL_TEXTURE_FOVEATED_NUM_FOCAL_POINTS_QUERY_QCOM: u32 = 0x8BFE;
pub const GL_FRAMEBUFFER_INCOMPLETE_FOVEATION_QCOM: u32 = 0x8BFF;
...
pub const GL_MODULATE_COLOR_IMG: u32 = 0x8C04;
pub const GL_RECIP_ADD_SIGNED_ALPHA_IMG: u32 = 0x8C05;
pub const GL_TEXTURE_ALPHA_MODULATE_IMG: u32 = 0x8C06;
pub const GL_FACTOR_ALPHA_MODULATE_IMG: u32 = 0x8C07;
pub const GL_FRAGMENT_ALPHA_MODULATE_IMG: u32 = 0x8C08;
pub const GL_ADD_BLEND_IMG: u32 = 0x8C09;
...
pub const GL_MAX_GEOMETRY_TEXTURE_IMAGE_UNITS_OES: u32 = 0x8C29;
...
pub const GL_TEXTURE_BUFFER_OES: u32 = 0x8C2A;
pub const GL_TEXTURE_BUFFER_BINDING: u32 = 0x8C2A;
pub const GL_TEXTURE_BUFFER_BINDING_EXT: u32 = 0x8C2A;
pub const GL_TEXTURE_BUFFER_BINDING_OES: u32 = 0x8C2A;
...
pub const GL_MAX_TEXTURE_BUFFER_SIZE_OES: u32 = 0x8C2B;
...
pub const GL_TEXTURE_BINDING_BUFFER_OES: u32 = 0x8C2C;
...
pub const GL_TEXTURE_BUFFER_DATA_STORE_BINDING_OES: u32 = 0x8C2D;
...
pub const GL_PRIMITIVES_GENERATED_OES: u32 = 0x8C87;
...
pub const GL_MOTION_ESTIMATION_SEARCH_BLOCK_X_QCOM: u32 = 0x8C90;
pub const GL_MOTION_ESTIMATION_SEARCH_BLOCK_Y_QCOM: u32 = 0x8C91;
...
pub const GL_LOWER_LEFT_EXT: u32 = 0x8CA1;
pub const GL_UPPER_LEFT: u32 = 0x8CA2;
pub const GL_UPPER_LEFT_EXT: u32 = 0x8CA2;
...
pub const GL_DRAW_FRAMEBUFFER_BINDING_ANGLE: u32 = 0x8CA6;
pub const GL_DRAW_FRAMEBUFFER_BINDING_APPLE: u32 = 0x8CA6;
pub const GL_DRAW_FRAMEBUFFER_BINDING_EXT: u32 = 0x8CA6;
pub const GL_DRAW_FRAMEBUFFER_BINDING_NV: u32 = 0x8CA6;
pub const GL_FRAMEBUFFER_BINDING: u32 = 0x8CA6;
pub const GL_FRAMEBUFFER_BINDING_ANGLE: u32 = 0x8CA6;
pub const GL_FRAMEBUFFER_BINDING_EXT: u32 = 0x8CA6;
pub const GL_FRAMEBUFFER_BINDING_OES: u32 = 0x8CA6;
pub const GL_RENDERBUFFER_BINDING: u32 = 0x8CA7;
pub const GL_RENDERBUFFER_BINDING_ANGLE: u32 = 0x8CA7;
pub const GL_RENDERBUFFER_BINDING_EXT: u32 = 0x8CA7;
pub const GL_RENDERBUFFER_BINDING_OES: u32 = 0x8CA7;
pub const GL_READ_FRAMEBUFFER: u32 = 0x8CA8;
pub const GL_READ_FRAMEBUFFER_ANGLE: u32 = 0x8CA8;
pub const GL_READ_FRAMEBUFFER_APPLE: u32 = 0x8CA8;
pub const GL_READ_FRAMEBUFFER_EXT: u32 = 0x8CA8;
pub const GL_READ_FRAMEBUFFER_NV: u32 = 0x8CA8;
pub const GL_DRAW_FRAMEBUFFER: u32 = 0x8CA9;
pub const GL_DRAW_FRAMEBUFFER_ANGLE: u32 = 0x8CA9;
pub const GL_DRAW_FRAMEBUFFER_APPLE: u32 = 0x8CA9;
pub const GL_DRAW_FRAMEBUFFER_EXT: u32 = 0x8CA9;
pub const GL_DRAW_FRAMEBUFFER_NV: u32 = 0x8CA9;
pub const GL_READ_FRAMEBUFFER_BINDING: u32 = 0x8CAA;
pub const GL_READ_FRAMEBUFFER_BINDING_ANGLE: u32 = 0x8CAA;
pub const GL_READ_FRAMEBUFFER_BINDING_APPLE: u32 = 0x8CAA;
pub const GL_READ_FRAMEBUFFER_BINDING_EXT: u32 = 0x8CAA;
pub const GL_READ_FRAMEBUFFER_BINDING_NV: u32 = 0x8CAA;
pub const GL_RENDERBUFFER_COVERAGE_SAMPLES_NV: u32 = 0x8CAB;
pub const GL_RENDERBUFFER_SAMPLES: u32 = 0x8CAB;
pub const GL_RENDERBUFFER_SAMPLES_ANGLE: u32 = 0x8CAB;
pub const GL_RENDERBUFFER_SAMPLES_APPLE: u32 = 0x8CAB;
pub const GL_RENDERBUFFER_SAMPLES_EXT: u32 = 0x8CAB;
pub const GL_RENDERBUFFER_SAMPLES_NV: u32 = 0x8CAB;
...
pub const GL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE_OES: u32 = 0x8CD0;
pub const GL_FRAMEBUFFER_ATTACHMENT_OBJECT_NAME: u32 = 0x8CD1;
pub const GL_FRAMEBUFFER_ATTACHMENT_OBJECT_NAME_EXT: u32 = 0x8CD1;
pub const GL_FRAMEBUFFER_ATTACHMENT_OBJECT_NAME_OES: u32 = 0x8CD1;
...
pub const GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_LEVEL_OES: u32 = 0x8CD2;
...
pub const GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_CUBE_MAP_FACE_OES: u32 = 0x8CD3;
pub const GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_3D_ZOFFSET_EXT: u32 = 0x8CD4;
pub const GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_3D_ZOFFSET_OES: u32 = 0x8CD4;
...
pub const GL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT_OES: u32 = 0x8CD6;
...
pub const GL_STENCIL_ATTACHMENT_OES: u32 = 0x8D20;
...
pub const GL_RENDERBUFFER_INTERNAL_FORMAT_OES: u32 = 0x8D44;
...
pub const GL_ANY_SAMPLES_PASSED_CONSERVATIVE_EXT: u32 = 0x8D6A;
pub const GL_MAX_ELEMENT_INDEX: u32 = 0x8D6B;
pub const GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_SAMPLES_EXT: u32 = 0x8D6C;
...
pub const GL_FRAMEBUFFER_ATTACHMENT_LAYERED_OES: u32 = 0x8DA7;
...
pub const GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS_OES: u32 = 0x8DA8;
...
pub const GL_SAMPLER_BUFFER_OES: u32 = 0x8DC2;
...
pub const GL_INT_SAMPLER_BUFFER_OES: u32 = 0x8DD0;
...
pub const GL_UNSIGNED_INT_SAMPLER_BUFFER_OES: u32 = 0x8DD8;
...
pub const GL_GEOMETRY_SHADER_OES: u32 = 0x8DD9;
...
pub const GL_MAX_GEOMETRY_UNIFORM_COMPONENTS_OES: u32 = 0x8DDF;
...
pub const GL_MAX_GEOMETRY_OUTPUT_VERTICES_OES: u32 = 0x8DE0;
...
pub const GL_MAX_GEOMETRY_TOTAL_OUTPUT_COMPONENTS_OES: u32 = 0x8DE1;
...
pub const GL_MAX_COMBINED_TESS_CONTROL_UNIFORM_COMPONENTS_EXT: u32 = 0x8E1E;
pub const GL_MAX_COMBINED_TESS_CONTROL_UNIFORM_COMPONENTS_OES: u32 = 0x8E1E;
pub const GL_MAX_COMBINED_TESS_EVALUATION_UNIFORM_COMPONENTS: u32 = 0x8E1F;
pub const GL_MAX_COMBINED_TESS_EVALUATION_UNIFORM_COMPONENTS_EXT: u32 = 0x8E1F;
pub const GL_MAX_COMBINED_TESS_EVALUATION_UNIFORM_COMPONENTS_OES: u32 = 0x8E1F;
...
pub const GL_TIMESTAMP_EXT: u32 = 0x8E28;
...
pub const GL_FIRST_VERTEX_CONVENTION_OES: u32 = 0x8E4D;
pub const GL_LAST_VERTEX_CONVENTION: u32 = 0x8E4E;
pub const GL_LAST_VERTEX_CONVENTION_EXT: u32 = 0x8E4E;
pub const GL_LAST_VERTEX_CONVENTION_OES: u32 = 0x8E4E;
...
pub const GL_MAX_GEOMETRY_SHADER_INVOCATIONS_EXT: u32 = 0x8E5A;
pub const GL_MAX_GEOMETRY_SHADER_INVOCATIONS_OES: u32 = 0x8E5A;
...
pub const GL_PATCH_VERTICES_EXT: u32 = 0x8E72;
pub const GL_PATCH_VERTICES_OES: u32 = 0x8E72;
pub const GL_PATCH_DEFAULT_INNER_LEVEL: u32 = 0x8E73;
pub const GL_PATCH_DEFAULT_INNER_LEVEL_EXT: u32 = 0x8E73;
pub const GL_PATCH_DEFAULT_OUTER_LEVEL: u32 = 0x8E74;
pub const GL_PATCH_DEFAULT_OUTER_LEVEL_EXT: u32 = 0x8E74;
pub const GL_TESS_CONTROL_OUTPUT_VERTICES: u32 = 0x8E75;
pub const GL_TESS_CONTROL_OUTPUT_VERTICES_EXT: u32 = 0x8E75;
pub const GL_TESS_CONTROL_OUTPUT_VERTICES_OES: u32 = 0x8E75;
pub const GL_TESS_GEN_MODE: u32 = 0x8E76;
pub const GL_TESS_GEN_MODE_EXT: u32 = 0x8E76;
pub const GL_TESS_GEN_MODE_OES: u32 = 0x8E76;
pub const GL_TESS_GEN_SPACING: u32 = 0x8E77;
pub const GL_TESS_GEN_SPACING_EXT: u32 = 0x8E77;
pub const GL_TESS_GEN_SPACING_OES: u32 = 0x8E77;
pub const GL_TESS_GEN_VERTEX_ORDER: u32 = 0x8E78;
pub const GL_TESS_GEN_VERTEX_ORDER_EXT: u32 = 0x8E78;
pub const GL_TESS_GEN_VERTEX_ORDER_OES: u32 = 0x8E78;
pub const GL_TESS_GEN_POINT_MODE: u32 = 0x8E79;
pub const GL_TESS_GEN_POINT_MODE_EXT: u32 = 0x8E79;
pub const GL_TESS_GEN_POINT_MODE_OES: u32 = 0x8E79;
pub const GL_ISOLINES: u32 = 0x8E7A;
pub const GL_ISOLINES_EXT: u32 = 0x8E7A;
pub const GL_ISOLINES_OES: u32 = 0x8E7A;
pub const GL_FRACTIONAL_ODD: u32 = 0x8E7B;
pub const GL_FRACTIONAL_ODD_EXT: u32 = 0x8E7B;
pub const GL_FRACTIONAL_ODD_OES: u32 = 0x8E7B;
pub const GL_FRACTIONAL_EVEN: u32 = 0x8E7C;
pub const GL_FRACTIONAL_EVEN_EXT: u32 = 0x8E7C;
pub const GL_FRACTIONAL_EVEN_OES: u32 = 0x8E7C;
pub const GL_MAX_PATCH_VERTICES: u32 = 0x8E7D;
pub const GL_MAX_PATCH_VERTICES_EXT: u32 = 0x8E7D;
pub const GL_MAX_PATCH_VERTICES_OES: u32 = 0x8E7D;
pub const GL_MAX_TESS_GEN_LEVEL: u32 = 0x8E7E;
pub const GL_MAX_TESS_GEN_LEVEL_EXT: u32 = 0x8E7E;
pub const GL_MAX_TESS_GEN_LEVEL_OES: u32 = 0x8E7E;
pub const GL_MAX_TESS_CONTROL_UNIFORM_COMPONENTS: u32 = 0x8E7F;
pub const GL_MAX_TESS_CONTROL_UNIFORM_COMPONENTS_EXT: u32 = 0x8E7F;
pub const GL_MAX_TESS_CONTROL_UNIFORM_COMPONENTS_OES: u32 = 0x8E7F;
pub const GL_MAX_TESS_EVALUATION_UNIFORM_COMPONENTS: u32 = 0x8E80;
pub const GL_MAX_TESS_EVALUATION_UNIFORM_COMPONENTS_EXT: u32 = 0x8E80;
pub const GL_MAX_TESS_EVALUATION_UNIFORM_COMPONENTS_OES: u32 = 0x8E80;
pub const GL_MAX_TESS_CONTROL_TEXTURE_IMAGE_UNITS: u32 = 0x8E81;
pub const GL_MAX_TESS_CONTROL_TEXTURE_IMAGE_UNITS_EXT: u32 = 0x8E81;
pub const GL_MAX_TESS_CONTROL_TEXTURE_IMAGE_UNITS_OES: u32 = 0x8E81;
pub const GL_MAX_TESS_EVALUATION_TEXTURE_IMAGE_UNITS: u32 = 0x8E82;
pub const GL_MAX_TESS_EVALUATION_TEXTURE_IMAGE_UNITS_EXT: u32 = 0x8E82;
pub const GL_MAX_TESS_EVALUATION_TEXTURE_IMAGE_UNITS_OES: u32 = 0x8E82;
pub const GL_MAX_TESS_CONTROL_OUTPUT_COMPONENTS: u32 = 0x8E83;
pub const GL_MAX_TESS_CONTROL_OUTPUT_COMPONENTS_EXT: u32 = 0x8E83;
pub const GL_MAX_TESS_CONTROL_OUTPUT_COMPONENTS_OES: u32 = 0x8E83;
pub const GL_MAX_TESS_PATCH_COMPONENTS: u32 = 0x8E84;
pub const GL_MAX_TESS_PATCH_COMPONENTS_EXT: u32 = 0x8E84;
pub const GL_MAX_TESS_PATCH_COMPONENTS_OES: u32 = 0x8E84;
pub const GL_MAX_TESS_CONTROL_TOTAL_OUTPUT_COMPONENTS: u32 = 0x8E85;
pub const GL_MAX_TESS_CONTROL_TOTAL_OUTPUT_COMPONENTS_EXT: u32 = 0x8E85;
pub const GL_MAX_TESS_CONTROL_TOTAL_OUTPUT_COMPONENTS_OES: u32 = 0x8E85;
pub const GL_MAX_TESS_EVALUATION_OUTPUT_COMPONENTS: u32 = 0x8E86;
pub const GL_MAX_TESS_EVALUATION_OUTPUT_COMPONENTS_EXT: u32 = 0x8E86;
pub const GL_MAX_TESS_EVALUATION_OUTPUT_COMPONENTS_OES: u32 = 0x8E86;
pub const GL_TESS_EVALUATION_SHADER: u32 = 0x8E87;
pub const GL_TESS_EVALUATION_SHADER_EXT: u32 = 0x8E87;
pub const GL_TESS_EVALUATION_SHADER_OES: u32 = 0x8E87;
pub const GL_TESS_CONTROL_SHADER: u32 = 0x8E88;
pub const GL_TESS_CONTROL_SHADER_EXT: u32 = 0x8E88;
pub const GL_TESS_CONTROL_SHADER_OES: u32 = 0x8E88;
pub const GL_MAX_TESS_CONTROL_UNIFORM_BLOCKS: u32 = 0x8E89;
pub const GL_MAX_TESS_CONTROL_UNIFORM_BLOCKS_EXT: u32 = 0x8E89;
pub const GL_MAX_TESS_CONTROL_UNIFORM_BLOCKS_OES: u32 = 0x8E89;
pub const GL_MAX_TESS_EVALUATION_UNIFORM_BLOCKS: u32 = 0x8E8A;
pub const GL_MAX_TESS_EVALUATION_UNIFORM_BLOCKS_EXT: u32 = 0x8E8A;
pub const GL_MAX_TESS_EVALUATION_UNIFORM_BLOCKS_OES: u32 = 0x8E8A;
...
pub const GL_TRP_IMG: u32 = 0x8EA0;
pub const GL_TRP_ERROR_CONTEXT_RESET_IMG: u32 = 0x8EA1;
pub const GL_TRP_UNSUPPORTED_CONTEXT_IMG: u32 = 0x8EA2;
pub const GL_PVRIC_SIGNATURE_MISMATCH_IMG: u32 = 0x8EA3;
pub const GL_COVERAGE_COMPONENT_NV: u32 = 0x8ED0;
pub const GL_COVERAGE_COMPONENT4_NV: u32 = 0x8ED1;
pub const GL_COVERAGE_ATTACHMENT_NV: u32 = 0x8ED2;
pub const GL_COVERAGE_BUFFERS_NV: u32 = 0x8ED3;
pub const GL_COVERAGE_SAMPLES_NV: u32 = 0x8ED4;
pub const GL_COVERAGE_ALL_FRAGMENTS_NV: u32 = 0x8ED5;
pub const GL_COVERAGE_EDGE_FRAGMENTS_NV: u32 = 0x8ED6;
pub const GL_COVERAGE_AUTOMATIC_NV: u32 = 0x8ED7;
...
pub const GL_NUM_SURFACE_COMPRESSION_FIXED_RATES_EXT: u32 = 0x8F6E;
pub const GL_FRAGMENT_SHADING_RATE_NON_TRIVIAL_COMBINERS_SUPPORTED_EXT: u32 = 0x8F6F;
...
pub const GL_IMAGE_BUFFER_OES: u32 = 0x9051;
...
pub const GL_INT_IMAGE_BUFFER_OES: u32 = 0x905C;
...
pub const GL_UNSIGNED_INT_IMAGE_BUFFER_OES: u32 = 0x9067;
...
pub const GL_PATH_FOG_GEN_MODE_NV: u32 = 0x90AC;
...
pub const GL_PATH_GEN_COLOR_FORMAT_NV: u32 = 0x90B2;
...
pub const GL_MAX_TESS_CONTROL_IMAGE_UNIFORMS_EXT: u32 = 0x90CB;
pub const GL_MAX_TESS_CONTROL_IMAGE_UNIFORMS_OES: u32 = 0x90CB;
pub const GL_MAX_TESS_EVALUATION_IMAGE_UNIFORMS: u32 = 0x90CC;
pub const GL_MAX_TESS_EVALUATION_IMAGE_UNIFORMS_EXT: u32 = 0x90CC;
pub const GL_MAX_TESS_EVALUATION_IMAGE_UNIFORMS_OES: u32 = 0x90CC;
pub const GL_MAX_GEOMETRY_IMAGE_UNIFORMS: u32 = 0x90CD;
pub const GL_MAX_GEOMETRY_IMAGE_UNIFORMS_EXT: u32 = 0x90CD;
pub const GL_MAX_GEOMETRY_IMAGE_UNIFORMS_OES: u32 = 0x90CD;
...
pub const GL_MAX_GEOMETRY_SHADER_STORAGE_BLOCKS_EXT: u32 = 0x90D7;
pub const GL_MAX_GEOMETRY_SHADER_STORAGE_BLOCKS_OES: u32 = 0x90D7;
pub const GL_MAX_TESS_CONTROL_SHADER_STORAGE_BLOCKS: u32 = 0x90D8;
pub const GL_MAX_TESS_CONTROL_SHADER_STORAGE_BLOCKS_EXT: u32 = 0x90D8;
pub const GL_MAX_TESS_CONTROL_SHADER_STORAGE_BLOCKS_OES: u32 = 0x90D8;
pub const GL_MAX_TESS_EVALUATION_SHADER_STORAGE_BLOCKS: u32 = 0x90D9;
pub const GL_MAX_TESS_EVALUATION_SHADER_STORAGE_BLOCKS_EXT: u32 = 0x90D9;
pub const GL_MAX_TESS_EVALUATION_SHADER_STORAGE_BLOCKS_OES: u32 = 0x90D9;
...
pub const GL_COLOR_ATTACHMENT_EXT: u32 = 0x90F0;
pub const GL_MULTIVIEW_EXT: u32 = 0x90F1;
pub const GL_MAX_MULTIVIEW_BUFFERS_EXT: u32 = 0x90F2;
pub const GL_CONTEXT_ROBUST_ACCESS: u32 = 0x90F3;
pub const GL_CONTEXT_ROBUST_ACCESS_EXT: u32 = 0x90F3;
pub const GL_CONTEXT_ROBUST_ACCESS_KHR: u32 = 0x90F3;
...
pub const GL_TEXTURE_2D_MULTISAMPLE_ARRAY_OES: u32 = 0x9102;
...
pub const GL_TEXTURE_BINDING_2D_MULTISAMPLE_ARRAY_OES: u32 = 0x9105;
...
pub const GL_SAMPLER_2D_MULTISAMPLE_ARRAY_OES: u32 = 0x910B;
pub const GL_INT_SAMPLER_2D_MULTISAMPLE_ARRAY: u32 = 0x910C;
pub const GL_INT_SAMPLER_2D_MULTISAMPLE_ARRAY_OES: u32 = 0x910C;
pub const GL_UNSIGNED_INT_SAMPLER_2D_MULTISAMPLE_ARRAY: u32 = 0x910D;
pub const GL_UNSIGNED_INT_SAMPLER_2D_MULTISAMPLE_ARRAY_OES: u32 = 0x910D;
...
pub const GL_MAX_SERVER_WAIT_TIMEOUT_APPLE: u32 = 0x9111;
pub const GL_OBJECT_TYPE: u32 = 0x9112;
pub const GL_OBJECT_TYPE_APPLE: u32 = 0x9112;
pub const GL_SYNC_CONDITION: u32 = 0x9113;
pub const GL_SYNC_CONDITION_APPLE: u32 = 0x9113;
pub const GL_SYNC_STATUS: u32 = 0x9114;
pub const GL_SYNC_STATUS_APPLE: u32 = 0x9114;
pub const GL_SYNC_FLAGS: u32 = 0x9115;
pub const GL_SYNC_FLAGS_APPLE: u32 = 0x9115;
pub const GL_SYNC_FENCE: u32 = 0x9116;
pub const GL_SYNC_FENCE_APPLE: u32 = 0x9116;
pub const GL_SYNC_GPU_COMMANDS_COMPLETE: u32 = 0x9117;
pub const GL_SYNC_GPU_COMMANDS_COMPLETE_APPLE: u32 = 0x9117;
pub const GL_UNSIGNALED: u32 = 0x9118;
pub const GL_UNSIGNALED_APPLE: u32 = 0x9118;
pub const GL_SIGNALED: u32 = 0x9119;
pub const GL_SIGNALED_APPLE: u32 = 0x9119;
pub const GL_ALREADY_SIGNALED: u32 = 0x911A;
pub const GL_ALREADY_SIGNALED_APPLE: u32 = 0x911A;
pub const GL_TIMEOUT_EXPIRED: u32 = 0x911B;
pub const GL_TIMEOUT_EXPIRED_APPLE: u32 = 0x911B;
pub const GL_CONDITION_SATISFIED: u32 = 0x911C;
pub const GL_CONDITION_SATISFIED_APPLE: u32 = 0x911C;
pub const GL_WAIT_FAILED: u32 = 0x911D;
pub const GL_WAIT_FAILED_APPLE: u32 = 0x911D;
...
pub const GL_MAX_GEOMETRY_INPUT_COMPONENTS_EXT: u32 = 0x9123;
pub const GL_MAX_GEOMETRY_INPUT_COMPONENTS_OES: u32 = 0x9123;
pub const GL_MAX_GEOMETRY_OUTPUT_COMPONENTS: u32 = 0x9124;
pub const GL_MAX_GEOMETRY_OUTPUT_COMPONENTS_EXT: u32 = 0x9124;
pub const GL_MAX_GEOMETRY_OUTPUT_COMPONENTS_OES: u32 = 0x9124;
...
pub const GL_RENDERBUFFER_SAMPLES_IMG: u32 = 0x9133;
pub const GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE_IMG: u32 = 0x9134;
pub const GL_MAX_SAMPLES_IMG: u32 = 0x9135;
pub const GL_TEXTURE_SAMPLES_IMG: u32 = 0x9136;
...
pub const GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE_AND_DOWNSAMPLE_IMG: u32 = 0x913C;
pub const GL_NUM_DOWNSAMPLE_SCALES_IMG: u32 = 0x913D;
pub const GL_DOWNSAMPLE_SCALES_IMG: u32 = 0x913E;
pub const GL_FRAMEBUFFER_ATTACHMENT_TEXTURE_SCALE_IMG: u32 = 0x913F;
...
pub const GL_MAX_SPARSE_ARRAY_TEXTURE_LAYERS_EXT: u32 = 0x919A;
...
pub const GL_TEXTURE_BUFFER_OFFSET_EXT: u32 = 0x919D;
pub const GL_TEXTURE_BUFFER_OFFSET_OES: u32 = 0x919D;
pub const GL_TEXTURE_BUFFER_SIZE: u32 = 0x919E;
pub const GL_TEXTURE_BUFFER_SIZE_EXT: u32 = 0x919E;
pub const GL_TEXTURE_BUFFER_SIZE_OES: u32 = 0x919E;
pub const GL_TEXTURE_BUFFER_OFFSET_ALIGNMENT: u32 = 0x919F;
pub const GL_TEXTURE_BUFFER_OFFSET_ALIGNMENT_EXT: u32 = 0x919F;
pub const GL_TEXTURE_BUFFER_OFFSET_ALIGNMENT_OES: u32 = 0x919F;
...
pub const GL_TEXTURE_SPARSE_EXT: u32 = 0x91A6;
pub const GL_VIRTUAL_PAGE_SIZE_INDEX_ARB: u32 = 0x91A7;
pub const GL_VIRTUAL_PAGE_SIZE_INDEX_EXT: u32 = 0x91A7;
pub const GL_NUM_VIRTUAL_PAGE_SIZES_ARB: u32 = 0x91A8;
pub const GL_NUM_VIRTUAL_PAGE_SIZES_EXT: u32 = 0x91A8;
pub const GL_SPARSE_TEXTURE_FULL_ARRAY_CUBE_MIPMAPS_ARB: u32 = 0x91A9;
pub const GL_SPARSE_TEXTURE_FULL_ARRAY_CUBE_MIPMAPS_EXT: u32 = 0x91A9;
pub const GL_NUM_SPARSE_LEVELS_ARB: u32 = 0x91AA;
pub const GL_NUM_SPARSE_LEVELS_EXT: u32 = 0x91AA;
...
pub const GL_UNPACK_FLIP_Y_WEBGL: u32 = 0x9240;
pub const GL_UNPACK_PREMULTIPLY_ALPHA_WEBGL: u32 = 0x9241;
pub const GL_CONTEXT_LOST_WEBGL: u32 = 0x9242;
pub const GL_UNPACK_COLORSPACE_CONVERSION_WEBGL: u32 = 0x9243;
pub const GL_BROWSER_DEFAULT_WEBGL: u32 = 0x9244;
pub const GL_UNMASKED_VENDOR_WEBGL: u32 = 0x9245;
pub const GL_UNMASKED_RENDERER_WEBGL: u32 = 0x9246;
pub const GL_MAX_CLIENT_WAIT_TIMEOUT_WEBGL: u32 = 0x9247;
pub const GL_TEXTURE_VIDEO_IMAGE_WEBGL: u32 = 0x9248;
pub const GL_SAMPLER_VIDEO_IMAGE_WEBGL: u32 = 0x9249;
...
pub const GL_COMPRESSED_R11_EAC_OES: u32 = 0x9270;
pub const GL_COMPRESSED_SIGNED_R11_EAC: u32 = 0x9271;
pub const GL_COMPRESSED_SIGNED_R11_EAC_OES: u32 = 0x9271;
pub const GL_COMPRESSED_RG11_EAC: u32 = 0x9272;
pub const GL_COMPRESSED_RG11_EAC_OES: u32 = 0x9272;
pub const GL_COMPRESSED_SIGNED_RG11_EAC: u32 = 0x9273;
pub const GL_COMPRESSED_SIGNED_RG11_EAC_OES: u32 = 0x9273;
pub const GL_COMPRESSED_RGB8_ETC2: u32 = 0x9274;
pub const GL_COMPRESSED_RGB8_ETC2_OES: u32 = 0x9274;
pub const GL_COMPRESSED_SRGB8_ETC2: u32 = 0x9275;
pub const GL_COMPRESSED_SRGB8_ETC2_OES: u32 = 0x9275;
pub const GL_COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2: u32 = 0x9276;
pub const GL_COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2_OES: u32 = 0x9276;
pub const GL_COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2: u32 = 0x9277;
pub const GL_COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2_OES: u32 = 0x9277;
pub const GL_COMPRESSED_RGBA8_ETC2_EAC: u32 = 0x9278;
pub const GL_COMPRESSED_RGBA8_ETC2_EAC_OES: u32 = 0x9278;
pub const GL_COMPRESSED_SRGB8_ALPHA8_ETC2_EAC: u32 = 0x9279;
pub const GL_COMPRESSED_SRGB8_ALPHA8_ETC2_EAC_OES: u32 = 0x9279;
...
pub const GL_PRIMITIVE_BOUNDING_BOX_EXT: u32 = 0x92BE;
pub const GL_PRIMITIVE_BOUNDING_BOX_OES: u32 = 0x92BE;
...
pub const GL_MAX_TESS_CONTROL_ATOMIC_COUNTER_BUFFERS_EXT: u32 = 0x92CD;
pub const GL_MAX_TESS_CONTROL_ATOMIC_COUNTER_BUFFERS_OES: u32 = 0x92CD;
pub const GL_MAX_TESS_EVALUATION_ATOMIC_COUNTER_BUFFERS: u32 = 0x92CE;
pub const GL_MAX_TESS_EVALUATION_ATOMIC_COUNTER_BUFFERS_EXT: u32 = 0x92CE;
pub const GL_MAX_TESS_EVALUATION_ATOMIC_COUNTER_BUFFERS_OES: u32 = 0x92CE;
pub const GL_MAX_GEOMETRY_ATOMIC_COUNTER_BUFFERS: u32 = 0x92CF;
pub const GL_MAX_GEOMETRY_ATOMIC_COUNTER_BUFFERS_EXT: u32 = 0x92CF;
pub const GL_MAX_GEOMETRY_ATOMIC_COUNTER_BUFFERS_OES: u32 = 0x92CF;
...
pub const GL_MAX_TESS_CONTROL_ATOMIC_COUNTERS_EXT: u32 = 0x92D3;
pub const GL_MAX_TESS_CONTROL_ATOMIC_COUNTERS_OES: u32 = 0x92D3;
pub const GL_MAX_TESS_EVALUATION_ATOMIC_COUNTERS: u32 = 0x92D4;
pub const GL_MAX_TESS_EVALUATION_ATOMIC_COUNTERS_EXT: u32 = 0x92D4;
pub const GL_MAX_TESS_EVALUATION_ATOMIC_COUNTERS_OES: u32 = 0x92D4;
pub const GL_MAX_GEOMETRY_ATOMIC_COUNTERS: u32 = 0x92D5;
pub const GL_MAX_GEOMETRY_ATOMIC_COUNTERS_EXT: u32 = 0x92D5;
pub const GL_MAX_GEOMETRY_ATOMIC_COUNTERS_OES: u32 = 0x92D5;
...
pub const GL_IS_PER_PATCH_EXT: u32 = 0x92E7;
pub const GL_IS_PER_PATCH_OES: u32 = 0x92E7;
...
pub const GL_REFERENCED_BY_TESS_CONTROL_SHADER_EXT: u32 = 0x9307;
pub const GL_REFERENCED_BY_TESS_CONTROL_SHADER_OES: u32 = 0x9307;
pub const GL_REFERENCED_BY_TESS_EVALUATION_SHADER: u32 = 0x9308;
pub const GL_REFERENCED_BY_TESS_EVALUATION_SHADER_EXT: u32 = 0x9308;
pub const GL_REFERENCED_BY_TESS_EVALUATION_SHADER_OES: u32 = 0x9308;
pub const GL_REFERENCED_BY_GEOMETRY_SHADER: u32 = 0x9309;
pub const GL_REFERENCED_BY_GEOMETRY_SHADER_EXT: u32 = 0x9309;
pub const GL_REFERENCED_BY_GEOMETRY_SHADER_OES: u32 = 0x9309;
...
pub const GL_LOCATION_INDEX_EXT: u32 = 0x930F;
...
pub const GL_FRAMEBUFFER_DEFAULT_LAYERS_EXT: u32 = 0x9312;
pub const GL_FRAMEBUFFER_DEFAULT_LAYERS_OES: u32 = 0x9312;
...
pub const GL_MAX_FRAMEBUFFER_LAYERS_EXT: u32 = 0x9317;
pub const GL_MAX_FRAMEBUFFER_LAYERS_OES: u32 = 0x9317;
...
pub const GL_CLIP_ORIGIN_EXT: u32 = 0x935C;
pub const GL_CLIP_DEPTH_MODE: u32 = 0x935D;
pub const GL_CLIP_DEPTH_MODE_EXT: u32 = 0x935D;
pub const GL_NEGATIVE_ONE_TO_ONE: u32 = 0x935E;
pub const GL_NEGATIVE_ONE_TO_ONE_EXT: u32 = 0x935E;
pub const GL_ZERO_TO_ONE: u32 = 0x935F;
pub const GL_ZERO_TO_ONE_EXT: u32 = 0x935F;
...
pub const GL_TRANSLATED_SHADER_SOURCE_LENGTH_ANGLE: u32 = 0x93A0;
...
pub const GL_GS_SHADER_BINARY_MTK: u32 = 0x9640;
pub const GL_GS_PROGRAM_BINARY_MTK: u32 = 0x9641;
pub const GL_MAX_SHADER_COMBINED_LOCAL_STORAGE_FAST_SIZE_EXT: u32 = 0x9650;
pub const GL_MAX_SHADER_COMBINED_LOCAL_STORAGE_SIZE_EXT: u32 = 0x9651;
pub const GL_FRAMEBUFFER_INCOMPLETE_INSUFFICIENT_SHADER_COMBINED_LOCAL_STORAGE_EXT: u32 = 0x9652;
pub const GL_TEXTURE_FOVEATED_CUTOFF_DENSITY_QCOM: u32 = 0x96A0;
pub const GL_FRAMEBUFFER_FETCH_NONCOHERENT_QCOM: u32 = 0x96A2;
pub const GL_VALIDATE_SHADER_BINARY_QCOM: u32 = 0x96A3;
pub const GL_SHADING_RATE_QCOM: u32 = 0x96A4;
pub const GL_SHADING_RATE_PRESERVE_ASPECT_RATIO_QCOM: u32 = 0x96A5;
pub const GL_SHADING_RATE_1X1_PIXELS_QCOM: u32 = 0x96A6;
pub const GL_SHADING_RATE_1X2_PIXELS_QCOM: u32 = 0x96A7;
pub const GL_SHADING_RATE_2X1_PIXELS_QCOM: u32 = 0x96A8;
pub const GL_SHADING_RATE_2X2_PIXELS_QCOM: u32 = 0x96A9;
pub const GL_SHADING_RATE_1X4_PIXELS_QCOM: u32 = 0x96AA;
pub const GL_SHADING_RATE_4X1_PIXELS_QCOM: u32 = 0x96AB;
pub const GL_SHADING_RATE_4X2_PIXELS_QCOM: u32 = 0x96AC;
pub const GL_SHADING_RATE_2X4_PIXELS_QCOM: u32 = 0x96AD;
pub const GL_SHADING_RATE_4X4_PIXELS_QCOM: u32 = 0x96AE;
pub const GL_SHADING_RATE_1X1_PIXELS_EXT: u32 = 0x96A6;
pub const GL_SHADING_RATE_1X2_PIXELS_EXT: u32 = 0x96A7;
pub const GL_SHADING_RATE_2X1_PIXELS_EXT: u32 = 0x96A8;
pub const GL_SHADING_RATE_2X2_PIXELS_EXT: u32 = 0x96A9;
pub const GL_SHADING_RATE_1X4_PIXELS_EXT: u32 = 0x96AA;
pub const GL_SHADING_RATE_4X1_PIXELS_EXT: u32 = 0x96AB;
pub const GL_SHADING_RATE_4X2_PIXELS_EXT: u32 = 0x96AC;
pub const GL_SHADING_RATE_2X4_PIXELS_EXT: u32 = 0x96AD;
pub const GL_SHADING_RATE_4X4_PIXELS_EXT: u32 = 0x96AE;
...
pub const GL_SURFACE_COMPRESSION_FIXED_RATE_1BPC_EXT: u32 = 0x96C4;
pub const GL_SURFACE_COMPRESSION_FIXED_RATE_2BPC_EXT: u32 = 0x96C5;
pub const GL_SURFACE_COMPRESSION_FIXED_RATE_3BPC_EXT: u32 = 0x96C6;
pub const GL_SURFACE_COMPRESSION_FIXED_RATE_4BPC_EXT: u32 = 0x96C7;
pub const GL_SURFACE_COMPRESSION_FIXED_RATE_5BPC_EXT: u32 = 0x96C8;
pub const GL_SURFACE_COMPRESSION_FIXED_RATE_6BPC_EXT: u32 = 0x96C9;
pub const GL_SURFACE_COMPRESSION_FIXED_RATE_7BPC_EXT: u32 = 0x96CA;
pub const GL_SURFACE_COMPRESSION_FIXED_RATE_8BPC_EXT: u32 = 0x96CB;
pub const GL_SURFACE_COMPRESSION_FIXED_RATE_9BPC_EXT: u32 = 0x96CC;
pub const GL_SURFACE_COMPRESSION_FIXED_RATE_10BPC_EXT: u32 = 0x96CD;
pub const GL_SURFACE_COMPRESSION_FIXED_RATE_11BPC_EXT: u32 = 0x96CE;
pub const GL_SURFACE_COMPRESSION_FIXED_RATE_12BPC_EXT: u32 = 0x96CF;
pub const GL_SHADING_RATE_EXT: u32 = 0x96D0;
pub const GL_SHADING_RATE_ATTACHMENT_EXT: u32 = 0x96D1;
pub const GL_FRAGMENT_SHADING_RATE_COMBINER_OP_KEEP_EXT: u32 = 0x96D2;
pub const GL_FRAGMENT_SHADING_RATE_COMBINER_OP_REPLACE_EXT: u32 = 0x96D3;
pub const GL_FRAGMENT_SHADING_RATE_COMBINER_OP_MIN_EXT: u32 = 0x96D4;
pub const GL_FRAGMENT_SHADING_RATE_COMBINER_OP_MAX_EXT: u32 = 0x96D5;
pub const GL_FRAGMENT_SHADING_RATE_COMBINER_OP_MUL_EXT: u32 = 0x96D6;
pub const GL_MIN_FRAGMENT_SHADING_RATE_ATTACHMENT_TEXEL_WIDTH_EXT: u32 = 0x96D7;
pub const GL_MAX_FRAGMENT_SHADING_RATE_ATTACHMENT_TEXEL_WIDTH_EXT: u32 = 0x96D8;
pub const GL_MIN_FRAGMENT_SHADING_RATE_ATTACHMENT_TEXEL_HEIGHT_EXT: u32 = 0x96D9;
pub const GL_MAX_FRAGMENT_SHADING_RATE_ATTACHMENT_TEXEL_HEIGHT_EXT: u32 = 0x96DA;
pub const GL_MAX_FRAGMENT_SHADING_RATE_ATTACHMENT_TEXEL_ASPECT_RATIO_EXT: u32 = 0x96DB;
pub const GL_MAX_FRAGMENT_SHADING_RATE_ATTACHMENT_LAYERS_EXT: u32 = 0x96DC;
pub const GL_FRAGMENT_SHADING_RATE_WITH_SHADER_DEPTH_STENCIL_WRITES_SUPPORTED_EXT: u32 = 0x96DD;
pub const GL_FRAGMENT_SHADING_RATE_WITH_SAMPLE_MASK_SUPPORTED_EXT: u32 = 0x96DE;
pub const GL_FRAGMENT_SHADING_RATE_ATTACHMENT_WITH_DEFAULT_FRAMEBUFFER_SUPPORTED_EXT: u32 = 0x96DF;
pub const GL_SHADER_CORE_COUNT_ARM: u32 = 0x96F0;
pub const GL_SHADER_CORE_ACTIVE_COUNT_ARM: u32 = 0x96F1;
pub const GL_SHADER_CORE_PRESENT_MASK_ARM: u32 = 0x96F2;
pub const GL_SHADER_CORE_MAX_WARP_COUNT_ARM: u32 = 0x96F3;
pub const GL_SHADER_CORE_PIXEL_RATE_ARM: u32 = 0x96F4;
pub const GL_SHADER_CORE_TEXEL_RATE_ARM: u32 = 0x96F5;
pub const GL_SHADER_CORE_FMA_RATE_ARM: u32 = 0x96F6;
